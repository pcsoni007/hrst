...
public class Tools {
    ...
    /*private void dialogDatePickerLight(final TextView tv, Context context) {
        ...
        DatePickerDialog datePicker = DatePickerDialog.newInstance(
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        Date date = new Date(date_ship_millis);
...
//                    .crossFade()
    ...
    public static String getFormattedDateOnly(Long dateTime) {
        @SuppressLint("SimpleDateFormat") SimpleDateFormat newFormat = new SimpleDateFormat("dd MMM yy");
        return newFormat.format(new Date(dateTime));
    }
