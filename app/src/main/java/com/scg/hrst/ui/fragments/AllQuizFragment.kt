...
import com.scg.hrst.ui.activity.QuizTestActivity
...
class AllQuizFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_quiz, container, false)
    }
    ...
    private fun handleClickEvent(item: EduQuizModel, position: Int) {
        requireActivity().launchActivity<QuizTestActivity> {  }
    }
